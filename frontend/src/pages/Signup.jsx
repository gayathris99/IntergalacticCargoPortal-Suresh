            ...
            <div className="relative z-10 w-full max-w-sm mx-4">
                <div className="bg-surface border border-border p-10 relative">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <p className="text-muted text-[10px] tracking-widest mt-1">CREATE YOUR ACCOUNT</p>
                    ...
                    <form onSubmit={handleSignup}>
                        ...
                        <div className="mb-6">
                            <label className="text-muted text-[9px] tracking-widest block mb-1">CONFIRM ACCESS CODE</label>
                            <input
                                type="password"
